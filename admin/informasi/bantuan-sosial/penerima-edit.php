...
$query = mysqli_query(
    ...
    SELECT
        ...
        s.title AS assistance_title,
        s.slug AS assistance_slug


    FROM social_assistance_recipients r


    INNER JOIN social_assistances s

    ON s.id = r.assistance_id
    ...
    <div class="mb-8 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div>
            ...
            <p class="mt-2 text-slate-500">
                ...
                Program:
                <?= htmlspecialchars($data['assistance_title']); ?>
        ...
        <div>
            ...
            <a
                ...
                href="penerima.php?id=<?= $data['assistance_id']; ?>"
                    ...
                    <div class="space-y-5 p-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($data['kk']); ?>"
                    ...
                    <div class="space-y-5 p-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($data['rtrw']); ?>"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($data['dusun']); ?>"
