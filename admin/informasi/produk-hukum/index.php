...
if ($status == "Published") {
    ...
    $where = "WHERE legal_instruments.status = 'Published'";
} elseif ($status == "Draft") {

    $where = "WHERE legal_instruments.status = 'Draft'";
}
...
if (!empty($search)) {
    ...
    if (empty($where)) {
        ...
        $where = "WHERE (
            ...
            legal_instruments.title LIKE '%$keyword%' OR
            legal_instruments.document_number LIKE '%$keyword%' OR
            legal_instruments.category LIKE '%$keyword%' OR
            legal_instruments.document_year LIKE '%$keyword%'
...
$query = mysqli_query($conn, "
    ...
    LEFT JOIN users
        ON users.id = legal_instruments.created_by

    $where

    ORDER BY

        legal_instruments.document_year DESC,
        legal_instruments.created_at DESC
                    ...
                    ?>
                            ...
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <span class="rounded-full bg-slate-100 px-3 py-1 text-sm whitespace-nowrap">
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <?= htmlspecialchars($row['document_year']); ?>
                                ...
                                <td class="px-6 py-5">
                                    ...
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <a
                                            ...
                                            class="flex h-10 w-10 items-center justify-center rounded-lg border bg-sky-100 text-sky-600 transition hover:bg-sky-200">
                                        ...
                                        <a
                                            ...
                                            class="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-500 text-white transition hover:bg-amber-600">
                                        ...
                                        <a
                                            ...
                                            class="flex h-10 w-10 items-center justify-center rounded-lg bg-red-500 text-white transition hover:bg-red-600">
                    ...
                    <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td colspan="10" class="px-6 py-20 text-center">
                                ...
                                <i class="bi bi-file-earmark-text text-5xl text-slate-300"></i>
                                ...
                                <p class="mt-2 text-slate-500">
                                    Silakan tambahkan produk hukum pertama.
                                </p>
