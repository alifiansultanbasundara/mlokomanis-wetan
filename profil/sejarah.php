                ...
                <div
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute left-0 mt-4 w-60 rounded-2xl bg-white shadow-xl border border-slate-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-200">
                            ...
                            <a href="#" class="block px-5 py-3 hover:bg-emerald-50 rounded-2xl">
                                Sejarah Desa
                            </a>
...
<section class="relative py-24 bg-gradient-to-b from-emerald-50 via-cyan-50 to-white">
    ...
    <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <p class="mt-6 text-lg text-gray-600 leading-8">
            ...
            Mengenal perjalanan sejarah dan perkembangan Desa
            <?= htmlspecialchars($data['nama_desa'] ?? '') ?>
            dari masa ke masa.
...
<div class="max-w-6xl mx-auto px-6 -mt-10">
    ...
    <img
        src="../profil_desa/uploads/profil_desa/<?= $data['foto_kantor']; ?>"
...
<section class="py-24">
    ...
    <div class="max-w-4xl mx-auto px-6">
        ...
        <div class="prose prose-lg max-w-none leading-9 text-gray-700">
...
<div class="max-w-5xl mx-auto px-6">
    ...
    <div class="rounded-3xl bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-12 text-center shadow-xl">

        <i class="bi bi-quote text-5xl opacity-30"></i>

        <h3 class="mt-4 text-3xl font-bold">

            <?= htmlspecialchars($data['motto'] ?? '') ?>
