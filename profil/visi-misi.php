...
<section class="relative py-24 bg-gradient-to-b from-emerald-50 via-cyan-50 to-white">
    ...
    <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <h1 class="mt-6 text-5xl font-extrabold text-gray-900">
            Visi &
            <span class="text-emerald-500">Misi</span>
        </h1>

        <p class="mt-6 text-lg text-gray-600 leading-8">
            Visi dan misi merupakan arah pembangunan serta komitmen Pemerintah Desa
            <?= htmlspecialchars($data['nama_desa'] ?? '') ?>
...
<div class="bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-3xl shadow-2xl p-12 text-white text-center">

    <div class="w-20 h-20 rounded-full bg-white/20 mx-auto flex items-center justify-center">
        <i class="bi bi-bullseye text-4xl"></i>
    </div>
...
<?php foreach ($misi as $index => $item): ?>
    ...
    <div class="group bg-white rounded-3xl border border-emerald-100 p-8 shadow-sm hover:-translate-y-2 hover:shadow-2xl transition">

        <div class="w-14 h-14 rounded-2xl bg-emerald-100 text-emerald-600 flex items-center justify-center font-bold text-xl">
        ...
        <p class="mt-5 text-gray-600 leading-8">
            ...
            <?= htmlspecialchars(trim(preg_replace('/^\d+[\.\)]\s*/', '', $item))) ?>
